...
a persistence unit "ExamenZhaguiMarcelaSerPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenZhaguiMarcelaSer\pom.xml":
...
artifact ("ExamenZhaguiMarcelaSer.war") is already built. You can build
